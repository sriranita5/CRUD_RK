            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <strong>Tambah Data Order</strong>
                        </div>
                            ...
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ url('order') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="varchar" id="id_order" name="id_order" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="tanggal_order" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="jumlah_order" class="form-control" autofocus required>
                                    </div>
