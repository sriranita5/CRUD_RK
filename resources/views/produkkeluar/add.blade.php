            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <strong>Tambah Data Produk Keluar</strong>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ url('produkkeluar') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label>ID Keluar</label>
                                        <input type="varchar" id="id_keluar" name="id_keluar" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Kode Produk</label>
                                        <input type="varchar" id="kode_produk" name="kode_produk" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Waktu Keluar</label>
                                        <input type="datetime-local" name="waktu_masuk" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Keluar</label>
                                        <input type="number" name="jumlah_masuk" class="form-control" autofocus required>
                                    </div>
