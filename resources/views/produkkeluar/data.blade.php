            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <strong>Data Produk Keluar</strong>
                        </div>
                        <div class="pull-right">
                            <a href="{{ url('produkkeluar/add') }}" class="btn btn-success btn-sm">
                                ...
                                @foreach ($produkkeluar as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('produkkeluar/edit/'. $item -> id_keluar) }}" class="btn btn-primary btn-sm">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <form action="{{ url('produkkeluar/'. $item -> id_keluar) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data?')">
                                                @method('delete')
                                                @csrf
