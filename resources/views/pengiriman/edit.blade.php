                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ url('pengiriman/' .$pengiriman->no_pengiriman) }}" method="post">
                                    @method('PATCH')
                                    @csrf
                                    <div class="form-group">
                                        <label>No Order</label>
                                        <input type="text" name="no_order" class="form-control" value="{{ $pengiriman->no_order }}" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>No Pengiriman</label>
                                        <input type="text" name="no_pengiriman" class="form-control" value="{{ $pengiriman->no_pengiriman }}" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal Kirim</label>
                                        <input type="text" name="tanggal_kirim" class="form-control" value="{{ $pengiriman->tanggal_kirim }}" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
                                        <input type="text" name="status" class="form-control" value="{{ $pengiriman->status }}" autofocus required>
                                    </div>
