                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            <a href="{{ url('pengiriman/add') }}" class="btn btn-success btn-sm">
                                ...
                                @foreach ($pengiriman as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('pengiriman/edit/'. $item -> no_pengiriman) }}" class="btn btn-primary btn-sm">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <form action="{{ url('pengiriman/'. $item -> no_pengiriman) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data?')">
                                                @method('delete')
                                                @csrf
