                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            <a href="{{ url('produks/add') }}" class="btn btn-success btn-sm">
                                ...
                                @foreach ($produks as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('produks/edit/' .$item->kode_produk) }}" class="btn btn-primary btn-sm">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <form action="{{ url('produks/' .$item->kode_produk) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data?')">
                                                @method('delete')
                                                @csrf
