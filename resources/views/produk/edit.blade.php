...
<head>
    ...
    <title>Produk - Prototype Kelompok 11</title>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            <a href="{{ url('produk/add') }}" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ url('produks/' .$produk->kode_produk) }}" method="post">
                                    @method('PATCH')
                                    @csrf
                                    <div class="form-group">
                                        <label>Kode Produk</label>
                                        <input type="text" name="kode_produk" class="form-control" value="{{ $produk->kode_produk }}" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Produk</label>
                                        <input type="text" name="nama_produk" class="form-control" value="{{ $produk->nama_produk }}" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Harga Beli</label>
                                        <input type="text" name="harga_beli" class="form-control" value="{{ $produk->harga_beli }}" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Harga Jual</label>
                                        <input type="text" name="harga_jual" class="form-control" value="{{ $produk->harga_jual }}" autofocus required>
                                    </div>
                                    <div class="form-group">
