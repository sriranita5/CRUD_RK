...
<head>
    ...
    <title>Gudang Rani Karina - Prototype Kelompok 11</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="{{ url('welcome') }}"> <i class="menu-icon fa fa-dashboard"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="{{ url('produks') }}"> <i class="menu-icon fa fa-shopping-bag"></i>Produk</a>
                    </li>
                    <li>
                        <a href="{{ url('produkkeluar') }}"> <i class="menu-icon fa fa-arrow-up"></i>Produk Keluar</a>
                    </li>
                    <li>
                        <a href="{{ url('produkmasuk') }}"> <i class="menu-icon fa fa-arrow-down"></i>Produk Masuk</a>
                    </li>
                    <li>
                        <a href="{{ url('order') }}"> <i class="menu-icon fa fa-shopping-cart"></i>Order</a>
                    </li>
                    <li>
                        <a href="{{ url('customer') }}"> <i class="menu-icon fa fa-user"></i>Customer</a>
                    </li>
                    <li>
                        <a href="{{ url('pengiriman') }}"> <i class="menu-icon fa fa-paper-plane"></i>Pengiriman</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active"><i class="fa-fa-dashbboard"></i></li>
                        </ol>
                    </div>
                </div>
            </div>
