                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            <a href="{{ url('customer/add') }}" class="btn btn-success btn-sm">
                                ...
                                @foreach ($customer as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('customer/edit/'. $item -> id_cust) }}" class="btn btn-primary btn-sm">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <form action="{{ url('customer/'. $item -> id_cust) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data?')">
                                                @method('delete')
                                                @csrf
