...
<head>
    ...
    <title>Customer - Prototype Kelompok 11</title>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            <a href="{{ url('customer') }}" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ url('customer/'. $customer->id_customer) }}" method="post">
                                    @method('PATCH')
                                    @csrf
                                    <div class="form-group">
                                        <label>ID Customer</label>
                                        <input type="varchar" id="id_cust" name="id_cust" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Customer</label>
                                        <input type="char" id="nama_cust" name="nama_cust" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Alamat Customer</label>
                                        <input type="char" id="alamat_cust" name="alamat_cust" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Nomor Order</label>
                                        <input type="varchar" id="no_order" name="no_order" class="nomor_order" autofocus required>
                                    </div>
