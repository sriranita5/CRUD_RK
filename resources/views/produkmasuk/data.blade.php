            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <strong>Data Produk Masuk</strong>
                        </div>
                        <div class="pull-right">
                            <a href="{{ url('produkmasuk/add') }}" class="btn btn-success btn-sm">
                                ...
                                @foreach ($produkmasuk as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('produkmasuk/edit/'. $item -> id_masuk) }}" class="btn btn-primary btn-sm">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <form action="{{ url('produkmasuk/'. $item -> id_masuk) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data?')">
                                                @method('delete')
                                                @csrf
