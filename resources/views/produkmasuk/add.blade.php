            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <strong>Tambahkan Data Produk Masuk</strong>
                        </div>
                            ...
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ url('produks') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_masuk" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Kode Produk</label>
                                        <input type="text" name="kode_produk" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Waktu Masuk</label>
                                        <input type="text" name="waktu_masuk" class="form-control" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Masuk</label>
                                        <input type="text" name="jumlah_masuk" class="form-control" autofocus required>
                                    </div>
